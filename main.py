...
class Game(arcade.Window):
    ...
    def on_draw(self):
        ...
        if (self.snake.score <= 0 and self.snake.status == True) or self.width < self.snake.center_x or  self.snake.center_x< 0 or \
           self.height < self.snake.center_y or  self.snake.center_y < 0:
